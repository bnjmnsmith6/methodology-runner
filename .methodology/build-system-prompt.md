...
## Project Context
Create a self-contained HTML file with a functional stopwatch featuring start, stop, and reset controls.

## This RP's Objective
Create a self-contained HTML file with a functional stopwatch featuring start, stop, and reset controls. Success criteria: Stopwatch displays time in readable format; Start button begins timing. Technical constraints: Must be single HTML file, No external dependencies.
