...
## Project Context
Create a self-contained HTML file that displays an animated dice that rolls 1-6 when clicked.

## This RP's Objective
Create a self-contained HTML file that displays an animated dice that rolls 1-6 when clicked. Success criteria: Single HTML file opens in browser; Clicking triggers dice roll animation. Technical constraints: Single HTML file, No external dependencies.
