...
## Project Context
Build a single HTML file that generates and displays random hex colors with matching backgrounds on button click.

## This RP's Objective
Build a single HTML file that generates and displays random hex colors with matching backgrounds on button click. Success criteria: Single HTML file runs without external dependencies; Button click generates random hex color. Technical constraints: Must be single HTML file, No external dependencies.
