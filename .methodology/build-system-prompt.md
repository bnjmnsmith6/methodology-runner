...
## Project Context
Build a clickable emotional state interface that displays facial expressions corresponding to selected emotions.

## This RP's Objective
Build a clickable emotional state interface that displays facial expressions corresponding to selected emotions. For Individual user (personal use). Success criteria: Clicking 'happy' displays a smiley face; Multiple emotions are clickable and show appropriate facial expressions.
