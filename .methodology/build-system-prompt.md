...
## Project Context
Build a single HTML file tip calculator that takes bill amount and tip percentage inputs and displays the total.

## This RP's Objective
Build a single HTML file tip calculator that takes bill amount and tip percentage inputs and displays the total. Success criteria: User can input bill amount; User can input tip percentage. Technical constraints: Must be single HTML file.
