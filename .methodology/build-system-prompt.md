...
## Project Context
Create a basic Python script that prints 'Hello World' for personal learning purposes.

## This RP's Objective
Create a basic Python script that prints 'Hello World' for personal learning purposes. For User (self-learning). Success criteria: Script executes without errors; Outputs 'Hello World' text. Technical constraints: Must be Python.
