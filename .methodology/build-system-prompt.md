...
## Project Context
Create a single-file HTML random number generator that displays numbers 1-100 on button click.

## This RP's Objective
Create a single-file HTML random number generator that displays numbers 1-100 on button click. Success criteria: Single HTML file opens in browser; Button click generates random number between 1-100 inclusive. Technical constraints: Single HTML file, No external dependencies.
...
## Out of Scope
- Number ranges other than 1-100
