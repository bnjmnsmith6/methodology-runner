...
## Project Context
Create a single-file HTML tip calculator that takes bill amount and tip percentage inputs and displays the total.

## This RP's Objective
Create a single-file HTML tip calculator that takes bill amount and tip percentage inputs and displays the total. Success criteria: Single HTML file that opens in a browser; Input field for bill amount accepts numbers. Technical constraints: Single HTML file, Must work in browser.
