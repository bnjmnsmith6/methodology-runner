...
## Project Context
Build a self-contained HTML coin flip simulator with click interaction and result tracking.

## This RP's Objective
Build a self-contained HTML coin flip simulator with click interaction and result tracking. Success criteria: Single HTML file contains complete application; Coin image flips when clicked. Technical constraints: Single HTML file delivery.

## Constraints
- Single HTML file delivery

## Acceptance Criteria
1. Coin image flips when clicked
